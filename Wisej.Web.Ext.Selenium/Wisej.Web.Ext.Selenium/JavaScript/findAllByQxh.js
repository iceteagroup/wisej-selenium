...
qxwebdriver.findAllByQxh = function () {
    ...
    return (function (args) {
        ...
        Qxh.prototype.findElements = function () {

            var resultArray = this.searchQxObjectByQxHierarchy(this.root, this.qxhParts);

            if (resultArray) {
                return this.getDomElementsFromWidgetArray(resultArray);
            }
        ...
        Qxh.prototype.getDomElementsFromWidgetArray = function (widgetArray) {
            if (
            ...
            if (step == '*')                 /* this is like '//' in XPath */ {
                ...
                for (var i = 0; i < childs.length; i++) {
                    try {
                        ...
                        var obj = this.searchQxObjectByQxHierarchy(childs[i], path);
