...
return (function(args) {
  ...
  var Qxh = function(locator, findOnlySeeable, rootElement) {
    ...
    if (typeof qx.application.Standalone !== "undefined" && app instanceof qx.application.Standalone) {
      this.appType = "desktop";
    } else if (typeof qx.application.Mobile !== "undefined" && app instanceof qx.application.Mobile) {
      this.appType = "mobile";
    } else if (typeof qx.application.Inline !== "undefined" && app instanceof qx.application.Inline) {
      this.appType = "inline";
    }
  ...
  Qxh.prototype.findElement = function() {
    var resultObject = this.searchQxObjectByQxHierarchy(this.root, this.qxhParts);
  ...
  Qxh.prototype.getDomElementFromWidget = function(widget) {
    ...
    if (typeof contentElement !== "undefined" && contentElement !== null && contentElement.nodeType && contentElement.nodeType === 1) {
      return contentElement;
    }

    var domElement;
    if (typeof contentElement !== "undefined" && contentElement !== null) {
      domElement = contentElement.getDomElement();
    }
  ...
  Qxh.prototype.getQxElementFromStep3 = function(root, childspec) {
    ...
    /* extract child index */
    var m = /child\[(-?\d+)\]/i.exec(childspec);
