...
{
    /// <summary>
    /// Represents a <see cref="T:Wisej.Web.TabPage"/> widget.
    /// </summary>
    /// <remarks>JavaScript class name is wisej.web.tabcontrol.TabPage</remarks>
    public class TabPage : QX.UI.Core.WidgetImpl
    {
        /// <summary>
